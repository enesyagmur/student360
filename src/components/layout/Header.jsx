  ...
  return (
    <header className="w-full h-[70px]  flex items-center justify-end sticky top-0 z-50 backdrop-blur-md bg-bg-secondary  transition-all duration-200 px-4  shadow-md">
      <div className="h-full flex items-center justify-end space-x-4">
        <button
          className="px-4 py-2 rounded-md text-sm font-medium text-text-secondary bg-bg-primary hover:bg-bg-secondary focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 transition duration-150 ease-in-out flex items-center space-x-2"
          onClick={toggleTheme}
        >
          <Sun className="h-4 w-4" />
        </button>

        <button className="px-4 py-2 rounded-md text-sm font-medium text-text-secondary bg-bg-primary hover:bg-bg-secondary focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 transition duration-150 ease-in-out flex items-center space-x-2">
          <BellRing />
        </button>
